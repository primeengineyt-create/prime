...
export default function SignInPage() {
    ...
    const handleGithubLogin = () => {
        // GitHub auth requires separate provider setup, keeping simulating for now or add if user requests
        setIsLoading(true);
        setTimeout(() => {
            router.push('/dashboard');
        }, 1000);
        ...
        <div className="auth-page">
            <div className="auth-container">
                ...
                <div className="auth-form-section">
                    ...
                    <div className="form-content">
                        <h1>Welcome back</h1>
                        <p className="subtitle">Sign in to continue building amazing apps</p>
                        ...
                        <div className="social-buttons">
                            ...
                            <button className="social-btn" onClick={handleGithubLogin} disabled={isLoading}>
                        ...
                        <div className="floating-cards">
                            <div className="card-wrapper card-1">
                                <TiltCard className="visual-card">
                                    ...
                                    <div className="card-text">Build 10x faster</div>
                                </TiltCard>
                            </div>
                            <div className="card-wrapper card-2">
                                <TiltCard className="visual-card">
                                    <div className="card-icon">🎨</div>
                                    <div className="card-text">Beautiful designs</div>
                                </TiltCard>
                            </div>
                            <div className="card-wrapper card-3">
                                <TiltCard className="visual-card">
                                    <div className="card-icon">🚀</div>
                                    <div className="card-text">Deploy instantly</div>
                                </TiltCard>
                            </div>
                        </div>
                        <h2>Build anything with AI</h2>
                        <p>Just describe your idea and watch it come to life</p>
                    </div>
                </div>
            </div>
            ...
            <style jsx>{`
                ...
                .auth-page::before {
                    ...
                    inset: 0;
                    background: 
                        radial-gradient(circle at 0% 0%, rgba(110, 56, 255, 0.15), transparent 50%),
                        radial-gradient(circle at 100% 100%, rgba(255, 77, 0, 0.1), transparent 50%),
                ...
                @keyframes float {
                    ...
                    50% { transform: translateY(-15px) rotate(var(--rot)) translateZ(var(--z)); }
                }
                ...
                .visual-gradient {
                    ...
                    inset: 0;
                    background: 
                        radial-gradient(circle at 100% 0%, rgba(110, 56, 255, 0.08), transparent 60%),
                        radial-gradient(circle at 0% 100%, rgba(255, 77, 0, 0.08), transparent 60%);
                }
